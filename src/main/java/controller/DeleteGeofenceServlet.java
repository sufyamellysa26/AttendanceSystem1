 ...
 * @author USER
 */
@WebServlet(name = "DeleteGeofenceServlet", urlPatterns = {"/DeleteGeofenceServlet"})
public class DeleteGeofenceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteGeofenceServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeleteGeofenceServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean deleted = geofenceDAO.deleteGeofence(geofenceId, staff.getStaffId());
            ...
            e.printStackTrace();
            request.setAttribute("error", "Error deleting geofence: " + e.getMessage());
            request.getRequestDispatcher("ErrorTechnicalStaff.jsp").forward(request, response);
        }
    }
